...
#define MENU_DATA_PIN         13  // SER / DS
#define MENU_OE_PIN           12  // OE (active LOW)
#define MENU_LATCH_PIN        11  // RCLK / ST_CP
#define MENU_SHIFT_PIN        10  // SRCLK / SH_CP
...
#define MAGNET_OE_PIN         5   // OE (active LOW)
#define MAGNET_LATCH_PIN      4   // RCLK / ST_CP
#define MAGNET_SHIFT_PIN      3   // SRCLK / SH_CP
